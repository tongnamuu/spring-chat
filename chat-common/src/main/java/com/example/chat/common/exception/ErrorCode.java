...
public enum ErrorCode {
    ...
    USERNAME_ALREADY_EXISTS("U003", "Username already exists"),
    ROOM_NOT_FOUND("R001", "Chat room not found"),
    ROOM_FULL("R002", "Chat room exceeds its maximum capacity"),
    ...
    INVALID_ROOM_CAPACITY("R006", "Capacity must be between 2 and 1500"),
